...
-   No terminal, usar o comando `quarto publish nome-do-arquivo.qmd` e seguir o passo a passo (no slide seguinte temos um exemplo).

##

``` bash
/cloud/project$ quarto publish index.qmd
? Provider: › Quarto Pub
? Authorize (Y/n) › Yes
